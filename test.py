...
class TestAmenity(unittest.TestCase):
    def test_save_valid(self):
        ...
        self.assertIsInstance(amenity.created_at, datetime.datetime, "Amenity created_at don't exist")
        ...
        self.assertIsInstance(amenity.updated_at, datetime.datetime, "Amenity updated_at don't exist")

    def test_save_invalid(self):
        amenityRepo = AmenityMockRepository(exist=False, create=True, exists=True)
        manager = RepositoryMockManager(amenityRepository=amenityRepo)
        amenity = Amenity(manager)
...
class TestCity(unittest.TestCase):
    def test_save_valid(self):
        ...
        manager = RepositoryMockManager(cityRepository=cityRepo, countryRepository=countryRepo)
        city = City(manager)
        city.name = "test"
        city.country_id = uuid.uuid4()
        self.assertIsInstance(city.id, uuid.UUID, "City id don't exist")
        self.assertIsInstance(city.created_at, datetime.datetime, "City created_at don't exist")
        ...
        self.assertIsInstance(city.updated_at, datetime.datetime, "City updated_at don't exist")
...
class TestCountry(unittest.TestCase):
    def test_save_valid(self):
        countryRepo = CountryMockRepository(exist=False, create=True)
        manager = RepositoryMockManager(countryRepository=countryRepo)
        country = Country(manager)
        country.name = "test"
        country.code = "test"
        self.assertIsInstance(country.id, uuid.UUID, "Country id don't exist")
        self.assertIsInstance(country.created_at, datetime.datetime, "Country created_at don't exist")
        self.assertTrue(country.save(), "Create country don't work")
        countryRepo._exist = True
        countryRepo._update = True
        countryRepo._exists = False
        self.assertTrue(country.save(), "Update country don't work")
        self.assertIsInstance(country.updated_at, datetime.datetime, "Country updated_at don't exist")

    def test_save_invalid(self):
        countryRepo = CountryMockRepository(exist=False, create=True, exists=True)
        manager = RepositoryMockManager(countryRepository=countryRepo)
        country = Country(manager)
        self.assertFalse(country.save(), "Create country work")
        country.name = "test"
        self.assertFalse(country.save(), "Create country work")
        country.code = "test"
        self.assertFalse(country.save(), "Create country work")
...
class TestPlace(unittest.TestCase):
    def test_save_valid(self):
        ...
        manager = RepositoryMockManager(placeRepository=placeRepo,
        ...
        self.assertIsInstance(place.created_at, datetime.datetime, "Place created_at don't exist")
        ...
        self.assertIsInstance(place.updated_at, datetime.datetime, "Place updated_at don't exist")
...
class TestReview(unittest.TestCase):
    def test_save_valid(self):
        reviewRepo = ReviewMockRepository(exist=False, create=True, exists=False)
        ...
        self.assertIsInstance(review.created_at, datetime.datetime, "Review created_at don't exist")
        ...
        self.assertIsInstance(review.updated_at, datetime.datetime, "Review updated_at don't exist")

    def test_save_invalid(self):
        reviewRepo = ReviewMockRepository(exist=False, create=True, exists=True)
...
class TestUser(unittest.TestCase):
    ...
    def test_save_valid(self):
        ...
        self.assertIsInstance(user.created_at, datetime.datetime, "User created_at don't exist")
        self.assertTrue(user.save(), "Create user don't work")
        userRepo._exist = True
        userRepo._update = True
        self.assertTrue(user.save(), "Update user don't work")
        self.assertIsInstance(user.updated_at, datetime.datetime, "User updated_at don't exist")
