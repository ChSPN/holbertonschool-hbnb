...
amenity = ns.model('Amenity', {
    'id': fields.String(readonly=True, description='The amenity unique identifier'),
    'created_at': fields.DateTime(readonly=True, description='The amenity created date'),
    'updated_at': fields.DateTime(readonly=True, description='The amenity updated date'),
