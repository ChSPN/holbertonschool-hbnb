...
place = ns.model(
    ...
    {
        "id": fields.String(
            readonly=True, description="The place unique identifier"
        ),
        "created_at": fields.DateTime(
            readonly=True, description="The place created date"
        ),
        "updated_at": fields.DateTime(
            readonly=True, description="The place updated date"
        ),
        ...
        "number_of_rooms": fields.Integer(
            description="The place number of rooms"
        ),
        "number_of_bathrooms": fields.Integer(
            description="The place number of bathrooms"
        ),
        "price_per_night": fields.Float(
            description="The place price per night"
        ),
        ...
        "amenity_ids": fields.List(
            fields.String(description="The place amenity identifier"),
            description="The place amenity identifiers",
        ),
    },
)
