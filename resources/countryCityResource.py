...
ns = Namespace(
    "Countries and Cities", description="Countries and Cities operations"
)
...
country = ns.model(
    ...
    {
        "id": fields.String(
            readonly=True, description="The country unique identifier"
        ),
        "created_at": fields.DateTime(
            readonly=True, description="The country created date"
        ),
        "updated_at": fields.DateTime(
            readonly=True, description="The country updated date"
        ),
...
city = ns.model(
    ...
    {
        "id": fields.String(
            readonly=True, description="The city unique identifier"
        ),
        "created_at": fields.DateTime(
            readonly=True, description="The city created date"
        ),
        "updated_at": fields.DateTime(
            readonly=True, description="The city updated date"
        ),
